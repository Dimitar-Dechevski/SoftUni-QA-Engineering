    ...
    public class CategoryTests : IDisposable
    {
        ...
        public void Test_CategoryLifecycle()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(getAllCategoriesResponse.Content.ToString(), Does.Contain("Test Category"), "Response content does not contain the expected value");
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(category["name"]?.ToString(), Is.EqualTo("Test Category"), "Category name does not match the expected value");
            });
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(updatedCategory["name"]?.ToString(), Is.EqualTo("Updated Test Category"), "Category name does not match the expected value");
            });
